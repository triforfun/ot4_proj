...
def run_automation():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            print("Esperando a que el menú 'Gestiona' esté visible...")
            gestiona_menu = page.get_by_text("Gestiona", exact=True)
            gestiona_menu.wait_for(timeout=60000)
            print("Menú 'Gestiona' encontrado.")

            print("Posicionando el ratón sobre 'Gestiona'...")
            gestiona_menu.hover()

            # --- CORRECCIÓN FINAL DE NAVEGACIÓN ---
            # Hacemos clic en el enlace que contiene el texto "Informe de inventario"
            print("Haciendo clic en 'Informe de inventario'...")
            ...
            for catalogo in CATALOGOS_A_DESCARGAR:
                ...
                page.locator('select[name="catalog_id"]').wait_for(timeout=30000)
