...
class StockUpdater:
    def __init__(self, carpeta_entrada, carpeta_salida, carpeta_backup):
        ...
        self.proveedores_config = {
            ...
            'HOKA FW24 Especialista.xlsx': {'proveedor': 'running_king', 'campos': {'ean': 'EAN', 'stock': 'Stock'}},
            'HOKA SS25 Especialista.xlsx': {'proveedor': 'running_king', 'campos': {'ean': 'EAN', 'stock': 'Stock'}}
        }
    ...
    def leer_archivo_proveedor(self, archivo_nombre, config):
        ...
        if not ruta_completa.exists():
            patron_glob = str(ruta_completa.parent / archivo_nombre.replace('.', '_*.'))
